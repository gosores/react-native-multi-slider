...
export default class MultiSlider extends React.Component {
  ...
  componentWillMount() {
    ...
    this._panResponderBetween = customPanResponder(
      ...
      gestureState => {
        throttle(this.moveOne, throttleWait, { trailing: false })(gestureState);
        throttle(this.moveTwo, throttleWait, { trailing: false })(gestureState);
      },
      gestureState => {
    ...
    this._panResponderOne = customPanResponder(
      this.startOne,
      throttle(this.moveOne, throttleWait, { trailing: false }),
      this.endOne,
    );
    this._panResponderTwo = customPanResponder(
      this.startTwo,
      throttle(this.moveTwo, throttleWait, { trailing: false }),
      this.endTwo,
    );
  }
